...
import com.sportsinventory.DAO.SupplierDAO;
...
public class ItemPage extends javax.swing.JPanel {
    ...
    public ItemPage(String username, Dashboard dashboard){
        initComponents();
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (productTable.getSelectedRow()<0)
            ...
            if (nameText.getText().equals("") || costText.getText().equals("")
                ...
                itemDTO.setItemName(nameText.getText());
                itemDTO.setDate(jDateChooser1.getDateFormatString());
                ...
                itemDTO.setDescription(brandText.getText());
    ...
    public void loadDataSet() {
        try {
            ...
            productTable.setModel(itemDAO.buildTableModel(itemDAO.getQueryResult()));
    ...
    public void loadSearchData(String text) {
        try {
            ItemDAO itemDAO = new ItemDAO();
            productTable.setModel(itemDAO.buildTableModel(itemDAO.getItemSearch(text)));
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    }
